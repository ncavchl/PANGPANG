...
export const MOCK_POLLS: Poll[] = [
  {
    id: 'low-vol-50-50',
    title: '8표 투표 테스트 (10표 이하)',
    question: '총 투표수가 10표 이하인 50대 50 투표입니다.',
    optionA: '선택 A',
    optionB: '선택 B',
    votesA: 4,
    votesB: 4,
  ...
  {
    id: 'high-vol-50-50',
    title: '12표 투표 테스트 (10표 초과)',
    question: '총 투표수가 10표 초과인 50대 50 투표입니다.',
    optionA: '선택 A',
    optionB: '선택 B',
    votesA: 6,
    votesB: 6,
  ...
  {
    id: 'massive-skewed-test',
    title: '압도적인 결과를 확인하는 투표',
    question: '10만 명 이상의 사용자가 참여한, 한쪽으로 매우 치우친 결과를 보여주는 테스트 투표입니다. 시스템이 올바르게 계산하고 표시하는지 확인합니다.',
    optionA: '압도적 다수 (99%)',
    optionB: '소수 의견 (1%)',
    votesA: 99000,
    votesB: 1000,
